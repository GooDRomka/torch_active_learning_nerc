...
class BiLSTM_CRF(nn.Module):
    def __init__(self, config):
        ...
        self.transitions.data[config.tag_to_ix["<START>"], :] = -10000
        self.transitions.data[:, config.tag_to_ix["<STOP>"]] = -10000
    ...
    def _make_list_of_words(self, tags, labels):
        all_tags = []
        all_labels = []
        ...
        return all_tags, all_labels

    def f1_score_span(self, labels, tags):
        all_tags, all_labels = self._make_list_of_words(tags, labels)
